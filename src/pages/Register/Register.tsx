...
const Register: React.FC = () =>  {
    ...
    return (
      ...
      />
            ...
            <IonButton expand='block' color='primary' id='login-main-button' size='large' className='button-styling' onClick={register}>Register<IonIcon className="arrow-icon" icon= {arrowForwardOutline}></IonIcon></IonButton>
